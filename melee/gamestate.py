...
class PlayerState(object):
    ...
    __slots__ = ('character', 'character_selected', 'x', 'y', 'percent', 'shield_strength', 'stock', 'facing',
                 'action', 'action_frame', 'invulnerable', 'invulnerability_left', 'hitlag_frames_left', 'hitstun_frames_left',
    ...
    def __init__(self):
        ...
        """(int): How many frames of hitlag are left for this character? 0 for not in hitlag"""
